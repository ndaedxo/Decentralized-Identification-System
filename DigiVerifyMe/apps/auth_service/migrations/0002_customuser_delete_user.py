    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wallet_address', models.CharField(blank=True, max_length=142)),
                ('role', models.CharField(choices=[('user', 'User')], default='user', max_length=50)),
                ('status', models.CharField(default='active', max_length=50)),
                ('profile_picture', models.URLField(blank=True, null=True)),
                ('social_media_links', models.JSONField(blank=True, null=True)),
                ('reputation_score', models.DecimalField(decimal_places=2, default=0.0, max_digits=5)),
                ('multi_signature_requirements', models.JSONField(blank=True, default=dict, null=True)),
